...
const Menubar = () => {
  ...
  const uniqItemsInCart = Object.values(quantities).filter(qty => qty > 0).length;
      ...
      <div className="d-flex align-align-items-center gap-4">
        <Link to={'/cart'}>
            <div className="position-relative">
              ...
              <span className="position-absolute top-0 start-100 translate-middle badge rouded-pill bg-warning">{uniqItemsInCart}</span>
            </div>
        </Link>
